...
#define PRINT_VAR(member1) xil_printf("%s %ld\r\n",#member1,(long)(member1))
#define PRINT_VAR2(member1,member2) xil_printf("%s %ld // %s %ld\r\n",#member1,(long)(member1),#member2,(long)(member2))
#define PRINT_VAR3(str,member1,member2) xil_printf("%s | %s %ld // %s %ld\r\n",#str,#member1,(long)(member1),#member2,(long)(member2))
