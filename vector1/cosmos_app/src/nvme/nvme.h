...
#define IO_NVM_SEARCH										0x10



/*Opcodes for Key-Vector I/O Commands*/
#define IO_NVM_KV_PUT										0xA0
#define IO_NVM_KV_GET										0xA1
#define IO_NVM_KV_DELETE									0xA2
#define IO_NVM_KV_PAUSE_BUILD								0xA3
#define IO_NVM_KV_RESUME_BUILD								0xA4
#define IO_NVM_UNUSED										0xA5
#define IO_NVM_VECTOR_BUILD_STATUS							0xA6
#define PRINT_TIME											0xA7
#define IO_NVM_VECTOR_SEARCH								0xA8
#define IO_NVM_VECTOR_BUILD									0xA9
...
#endif	// VECTOR1_COSMOS_APP_SRC_NVME_NVME_H_
